const questions = [
    ...
    
    {
        ...
        answers: [
            ...
            { text: "b)Para garantir que o sistema operativo funcione corretamente no hardware disponivel  ", correct: true  },
...
function checkAnswer(selectedAnswer, clickedButton) {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        document.getElementById('next-btn').innerText = 'Reiniciar Quiz';
